...
<div style="margin-left: 33%">
    <div class="row">
        <form action="controller" method="post">
            ...
            <input type="number" name="weight" class="form-control w-25" value="">
    ...
    <form action="controller" onsubmit="if(!confirm('Вы уверены что хотите изменить?')) {
        ...
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <input type="login" name="login" minlength="6" maxlength="10" place-holder="6-10 символов"
                       class="w-100 form-control" value="${user.login}"
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="password" minlength="6" maxlength="10" place-holder="6-10 символов"
                       value="${user.password}" class="w-100 form-control"
