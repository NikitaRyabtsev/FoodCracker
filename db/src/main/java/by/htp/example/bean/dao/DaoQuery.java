...
//User
	...
	String SQL_QUERY_GET_USER_ACCESS_INFO = "SELECT login,password=,name,secondName, email,sex,weight,dateOfBirth WHERE idUser=?";
	String SQL_QUERY_GET_ADMIN_ACCESS_INFO = "SELECT login,password=,name,secondName, email,sex,weight,dateOfBirth , role,block WHERE idUser=?";
